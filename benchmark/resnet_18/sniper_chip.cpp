...
int main(int argc, char** argv)
{
    ...
    InterChiplet::sendMessage(0, 0, idX, idY, A, (224 * 224 * 3));
    InterChiplet::receiveMessage(idX, idY, 3, 0, B, (7 * 7 * 512));
    ...
    Ort::Session session(env, "/home/gh/Chiplet_Heterogeneous_newVersion/benchmark/resnet18/resnet18.onnx", session_options);
