...
int main(int argc, char **argv){
    ...
    InterChiplet::sendMessage(1, 0, idX, idY, dataA, Row_A * Col_A * sizeof(int64_t));
    InterChiplet::sendMessage(1, 1, idX, idY, dataA, Row_A * Col_A * sizeof(int64_t));
    InterChiplet::sendMessage(1, 0, idX, idY, dataB, Row_B * Col_B * sizeof(int64_t));
    InterChiplet::sendMessage(1, 1, idX, idY, dataB, Row_B * Col_B * sizeof(int64_t));
    InterChiplet::receiveMessage(idX, idY, 1, 0, dataC, Row_A * Col_B * sizeof(int64_t));
    InterChiplet::receiveMessage(idX, idY, 1, 1, dataC, Row_A * Col_B * sizeof(int64_t));
    delete[] dataA;
    delete[] dataB;
    delete[] dataC;
